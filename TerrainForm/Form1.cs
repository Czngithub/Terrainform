...
namespace TerrainForm
{
    ...
    {
        //通过高度图来生成地形， 通过读取高度图上象元的值来获取该坐标位置的高程，然后根据高程值及坐标值形成一个规则的三角网，
        //通过采用索引编号的方式来实现，可以节约内存。
        ...
        public Form1()
        {
            ...
            //this.WindowState = System.Windows.Forms.FormWindowState.Maximized;全屏显示
            this.Text = "地形";//指定窗体标题
        }
        ...
        private void LoadTexturesAndMaterials()//导入贴图和材质
        {
            ...
            texture = TextureLoader.FromFile(device, @"C:\Users\yulanli\Desktop\TerrainForm\colorMap.jpg");
        }
        ...
        protected override void OnSizeChanged(EventArgs e) //2016-12-20，郭定义
        {
